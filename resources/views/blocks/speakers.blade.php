...
<section
    ...
    @class([ 'b-speakers relative overflow-visible -smt' ,
    ...
    <div class="__wrapper c-main grid grid-cols-1 md:grid-cols-2 gap-10">
        <h2 data-gsap-element="header" class="m-header">{{ strip_tags($g_speakers['header']) }}</h2>
    ...
    <div class="c-main pt-12">
        <div class="swiper speakers-swiper !overflow-visible">
            <div class="swiper-wrapper">
                @foreach ($r_speakers as $speaker)
                    ...
                    <div class="block h-full">
                        <div data-gsap-element="card" class="__card relative bg-white radius p-6 h-full">
                            ...
                            <div class="radius-img">
                                <img class="h-[360px] w-full radius-img object-cover mb-6" src="{{ $speaker['photo']['url'] }}" alt="{{ $speaker['photo']['alt'] ?: $speaker['name'] }}" />
                            </div>
                            @endif
    ...
    @if (!empty($g_speakers['image']))
    <img data-gsap-element="bg" class="__bg absolute -bottom-10 -left-10 pointer-events-none" src="{{ $g_speakers['image']['url'] }}" />
    @endif
</section>